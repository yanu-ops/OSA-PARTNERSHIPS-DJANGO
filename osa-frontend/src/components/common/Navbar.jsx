      ...
      <nav className="bg-red-700 shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <p className="text-xs text-red-100"><strong>Holy Cross of Davao College</strong></p>
            </div>
          </div>
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-3 hover:bg-red-800 px-3 py-2 rounded-lg transition-colors"
              >
                <div className="flex items-center space-x-2">
                  <User className="w-5 h-5 text-white" />
                  <div className="text-left">
                    <p className="text-sm font-medium text-white">{user?.full_name}</p>
                    <p className="text-xs text-red-100"><strong>{user?.email}</strong></p>
                  </div>
                </div>
